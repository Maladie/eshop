...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="authorName" id="authorName" placeholder="Enter author name" value="${product.parametersMap["author"].name}" required>
        </div>
        <div class="form-group">
            <label for="authorSurname">Author's Surname:</label>
            <input type="text" class="form-control" name="authorSurname" id="authorSurname" placeholder="Enter author surname" value="${product.parametersMap["author"].surname}" required>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="isbn13" id="isbn13" placeholder="Enter isbn13" value="${product.parametersMap["isbn13"]}" required>
        </div>
        <div class="form-group">
            <label for="isbn10">ISBN10:</label>
            <input type="text" class="form-control" name="isbn10" id="isbn10" placeholder="Enter isbn10" value="${product.parametersMap["isbn10"]}" required>
        </div>
    </div>
    <div class="col-md-3">
